...
import com.facebook.fresco.sample.adapters.FrescoAdapter;
import com.facebook.fresco.sample.adapters.GlideAdapter;
import com.facebook.fresco.sample.adapters.ImageListAdapter;
import com.facebook.fresco.sample.adapters.PicassoAdapter;
import com.facebook.fresco.sample.adapters.UilAdapter;
import com.facebook.fresco.sample.adapters.VolleyAdapter;
import com.facebook.fresco.sample.adapters.VolleyDraweeAdapter;
...
import com.facebook.fresco.sample.urlsfetcher.ImageFormat;
...
public class MainActivity extends ActionBarActivity {
	...
	private void setAdapter(int index) {
		...
		case FRESCO_OKHTTP_INDEX:
			mCurrentAdapter = new FrescoAdapter(this, R.id.image_list, mPerfListener,
					index == FRESCO_INDEX ? ImagePipelineConfigFactory.getImagePipelineConfig(this)
		...
		case UIL_INDEX:
			...
			break;
		case VOLLEY_INDEX:
			mCurrentAdapter = mUseDrawee ? new VolleyDraweeAdapter(this, R.id.image_list, mPerfListener) : new VolleyAdapter(this, R.id.image_list,
					mPerfListener);
			break;
		default:
			mCurrentAdapter = null;
	...
	private void reloadUrls() {
		...
		ImageUrlsRequestBuilder builder = new ImageUrlsRequestBuilder(url).addImageFormat(ImageFormat.JPEG, ImageSize.LARGE_THUMBNAIL)
	...
	private void updateStats() {
		...
		// When changing format of output below, make sure to sync
		// "scripts/test_runner.py" as well.
