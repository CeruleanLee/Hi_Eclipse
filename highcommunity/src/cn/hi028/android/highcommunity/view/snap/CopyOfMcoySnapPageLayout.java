 ...
 */
public class CopyOfMcoySnapPageLayout extends ViewGroup {
	...
	public CopyOfMcoySnapPageLayout(Context context, AttributeSet att) {
		this(context, att, 0);
	}
	
	public CopyOfMcoySnapPageLayout(Context context, AttributeSet attrs, int defStyle) {
