...
public class Auto_ScrollViewContainer extends RelativeLayout {
	...
	public Auto_ScrollViewContainer(Context context) {
		super(context);
		init();
	}

	public Auto_ScrollViewContainer(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public Auto_ScrollViewContainer(Context context, AttributeSet attrs, int defStyle) {
