//package cn.hi028.android.highcommunity.activity.alliancegoods;
//
...
//	TextView subimg,addimg,kucun,conttv,detail,goodname,guige,origin,telephone;
//	TextView time,guige_,origin_,edible_;
//	Button goPay;
//	TextView caramount,mAllprice;
//	View viewline1;View viewline2;View viewline3;View call;
//	FrameLayout shopcar;
...
//		setContentView(R.layout.shop_detail_activity2);
...
////
////		mPicDetail.setOnClickListener(new OnClickListener() {
////
////			@Override
////			public void onClick(View arg0) {
////				((CheckedTextView) arg0).setChecked(true);
...
//			}
//		});
////		mCommentDetail.setOnClickListener(new OnClickListener() {
////
////			@Override
////			public void onClick(View arg0) {
...
//		name = (TextView) findViewById(R.id.ac_shop_detail_goods_name);
//		price = (TextView) findViewById(R.id.ac_shop_detail_goods_price);
//		headimg = (ImageView) findViewById(R.id.ac_shop_goods_head_iv);
//		subimg = (TextView) findViewById(R.id.ac_shop_goods_right_sub_iv);
//		addimg = (TextView) findViewById(R.id.ac_shop_goods_right_add_iv);
//		kucun = (TextView) findViewById(R.id.ac_shop_detail_goods_count);
//		conttv = (TextView) findViewById(R.id.ac_shop_goods_list_right_counts);
//		detail = (TextView) findViewById(R.id.ac_shop_detail_tv);
//		goodname = (TextView) findViewById(R.id.shop_detail_ac_goods_name);
//		guige = (TextView) findViewById(R.id.ac_shop_detail_speci_tv);
//		origin = (TextView) findViewById(R.id.ac_shop_origin_tv);
//		telephone = (TextView) findViewById(R.id.shop_detail_service_telephone);
//		time = (TextView) findViewById(R.id.ac_shop_detail_service_time);
////		tuwenxiangqing = (RelativeLayout) findViewById(R.id.ac_shop_look_map_detail);
////		goodevaluation = (RelativeLayout) findViewById(R.id.ac_shop_look_good_detail);
//		payrl = (LinearLayout) findViewById(R.id.shop_deatil_bottom_pay_rl);
//
//		guige_ = (TextView) findViewById(R.id.ac_shop_good_speci);
//		origin_ = (TextView) findViewById(R.id.ac_shop_origin);
//		edible_ = (TextView) findViewById(R.id.ac_shop_edible);
//		edible = (TextView) findViewById(R.id.ac_shop_edible_tv);
//		call = findViewById(R.id.call);
//		goPay = (Button) findViewById(R.id.ac_shop_car_go_pay);
//		mPicDetail=(RadioButton) findViewById(R.id.ac_shopdetail_mypicdetail);
//		mCommentDetail=(RadioButton) findViewById(R.id.ac_shopdetail_mycommentdetail);
//		shopcar = (FrameLayout) findViewById(R.id.ac_shop_car_fl);
//
//		viewline1 = findViewById(R.id.view11);
//		viewline2 = findViewById(R.id.view12);
//		viewline3 = findViewById(R.id.view13);
//	}
//
...
//			if (good_count==0) {
//				Toast.makeText(GoodsDetailActivity.this, "请选择商品数量", 0).show();
//				return;
//			}
//			upDateList();
...
//			return ((CommunityFrag) mPagerAdapter.getItem(0)).onKeyDown();
//		}
//		return false;
//	}
//
