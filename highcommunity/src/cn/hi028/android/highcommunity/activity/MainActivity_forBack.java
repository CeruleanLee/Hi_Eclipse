...
import cn.hi028.android.highcommunity.activity.alliancegoods.AllianceOrder;
 ...
 * 主界面
 */
public class MainActivity_forBack extends BaseFragmentActivity implements View.OnClickListener, NeighborFrag.MyChangeListener {
	/**底部tabs**/
...
//		Toast.makeText(MainActivity.this,"HighCommunityApplication.isAliPayInStalled()"+HighCommunityApplication.isAliPayInStalled(), 0).show();
	...
	public class MessageReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			if (MESSAGE_RECEIVED_ACTION.equals(intent.getAction())) {
				...
				if (extras == 1) {
					mRightTop.setVisibility(android.view.View.VISIBLE);
				} else {
	...
	private void setStyleCustom() {
		CustomPushNotificationBuilder builder = new CustomPushNotificationBuilder(
				MainActivity_forBack.this, R.layout.customer_notitfication_layout,
	...
	View.OnClickListener mLeftMenuListener = new View.OnClickListener() {
		...
		public void onClick(View view) {
			Intent mLeftjump = new Intent(MainActivity_forBack.this,
			...
			if (view.getId() == R.id.ll_leftMenu_setting) {
				...
				MainActivity_forBack.this.startActivity(mLeftjump);
				return;
			}
			if (HighCommunityUtils.isLogin(MainActivity_forBack.this)) {
				switch (view.getId()) {
				...
				case R.id.ll_leftMenu_alliance_Order:
					Intent intent = new Intent(MainActivity_forBack.this,
							AllianceOrder.class);
	...
	public void onClick(View v) {
		...
		case R.id.main_tab_third://
			if (HighCommunityUtils.GetInstantiation()
					.isLogin(MainActivity_forBack.this)) {
		...
		case R.id.tx_LeftFrag_userlocation:
			VallageAct.toStartAct(MainActivity_forBack.this, 1, false);
			// finish();
			break;
		default:
			break;
