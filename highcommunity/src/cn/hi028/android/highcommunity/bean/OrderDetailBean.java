...
public class OrderDetailBean {
	...
	public String toString() {
		return "OrderDetailBean [orginal_price=" + orginal_price + ", status="
				+ status + ", current_price=" + current_price + ", zero_money="
				+ zero_money + ", tel=" + tel + ", join_price=" + join_price
				+ ", out_trade_no=" + out_trade_no + ", total_price="
				+ total_price + ", real_price=" + real_price + ", num=" + num
				+ ", address=" + address + ", cover_pic=" + cover_pic
				+ ", pay_type=" + pay_type + ", real_name=" + real_name
				+ ", name=" + name + ", create_time=" + create_time
