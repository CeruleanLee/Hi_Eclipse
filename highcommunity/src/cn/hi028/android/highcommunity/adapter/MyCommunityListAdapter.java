 ...
 * @时间：2015-12-08<br>
 */
public class MyCommunityListAdapter extends BaseFragmentAdapter {
    ...
    public MyCommunityListAdapter(BaseFragmentActivity mContext) {
            ...
            public void onClick(View view) {
                ...
                HTTPHelper.GetPoerate(new BpiHttpHandler.IBpiHttpHandler() {
                    ...
                    public void onSuccess(Object message) {
                        ...
                        mWindow = HighCommunityUtils.GetInstantiation().ShowMyCollectionShare(mContext, mopeate, mBean.getMid(), mViewHolder.mAssist, new HighCommunityUtils.CancalFravite() {
                            @Override
                            public void OnCancal() {
                                mList.remove(position);
                                notifyDataSetChanged();
                            }
                        }, new HighCommunityUtils.OnDeleteClick() {
                            @Override
                            public void OnClick() {
                                mList.remove(position);
                                notifyDataSetChanged();
