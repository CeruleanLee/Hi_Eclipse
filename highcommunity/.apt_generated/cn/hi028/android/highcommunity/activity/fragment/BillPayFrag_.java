...
public final class BillPayFrag_
    extends cn.hi028.android.highcommunity.activity.fragment.BillPayFrag
    implements HasViews, OnViewChangedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView_ == null) {
            contentView_ = inflater.inflate(layout.frag_billpay, container, false);
        }
        return contentView_;
    }
    ...
    public static BillPayFrag_.FragmentBuilder_ builder() {
        return new BillPayFrag_.FragmentBuilder_();
    }
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<BillPayFrag_.FragmentBuilder_, cn.hi028.android.highcommunity.activity.fragment.BillPayFrag>
    {


        @Override
        public cn.hi028.android.highcommunity.activity.fragment.BillPayFrag build() {
            BillPayFrag_ fragment_ = new BillPayFrag_();
