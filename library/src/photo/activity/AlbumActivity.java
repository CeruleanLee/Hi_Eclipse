...
import photo.adapter.AlbumGridViewAdapter;
import photo.util.AlbumHelper;
import photo.util.Bimp;
import photo.util.ImageBucket;
...
//            startActivity(intent);
    ...
    private void init() {
        ...
        okButton.setText(Res.getString("finish") + "(" + (Bimp.tempSelectBitmap.size() - 1)
                + "/" + PublicWay.num + ")");
    }
        ...
        gridImageAdapter
                .setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(final ToggleButton toggleButton,
                        ...
                        if (Bimp.tempSelectBitmap.size() - 1 >= PublicWay.num) {
                        ...
                        if (isChecked) {
                            ...
                            chooseBt.setVisibility(View.GONE);
                            okButton.setText(Res.getString("finish") + "(" + (Bimp.tempSelectBitmap.size() - 1) + "/" + PublicWay.num + ")");
                        }
                        isShowOkBt();
                    }
                });
